...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final AmapLibraryAccessors laccForAmapLibraryAccessors = new AmapLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>amap</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public AmapLibraryAccessors getAmap() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAmapLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class AmapLibraryAccessors extends SubDependencyFactory {

        public AmapLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>location</b> with <b>com.amap.api:location</b> coordinates and
         * with version reference <b>amapLocation</b>
         * <p>
        ...
        public Provider<MinimalExternalModuleDependency> getLocation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("amap.location");
        }

        /**
         * Dependency provider for <b>map3d</b> with <b>com.amap.api:3dmap</b> coordinates and
         * with version reference <b>amapMap3d</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getMap3d() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("amap.map3d");
        }

        /**
         * Dependency provider for <b>search</b> with <b>com.amap.api:search</b> coordinates and
         * with version reference <b>amapSearch</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>amapLocation</b> with value <b>6.4.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAmapLocation() { return getVersion("amapLocation"); }

        /**
         * Version alias <b>amapMap3d</b> with value <b>9.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAmapMap3d() { return getVersion("amapMap3d"); }

        /**
         * Version alias <b>amapSearch</b> with value <b>9.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAmapSearch() { return getVersion("amapSearch"); }
